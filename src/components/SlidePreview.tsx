  ...
  return (
    <div className="preview-container space-y-5 max-w-6xl mx-auto font-['Gotham']">
      ...
      {isLousaActive && !isExportingPng && (
        <div className="bg-slate-950/95 border border-purple-500/60 p-2.5 rounded-2xl shadow-2xl flex flex-wrap items-center justify-between gap-3 text-xs font-['Gotham'] animate-in fade-in duration-200">
